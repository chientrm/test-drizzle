// .wrangler/tmp/bundle-JHBEZC/checked-fetch.js
...
var N = async (o17) => {
  if (!o17.ok)
    throw new Error(JSON.stringify({ status: o17.status, statusText: o17.statusText, message: await o17.text() }));
};
...
var K = class o5 extends d {
  ...
  async raw() {
    let { host: e, metadata: a, name: r } = this, { query: t, values: n } = a, s = new f({ host: e, name: r, metadata: { query: t, values: n } });
    return console.log({ query: t, values: n }), s.post();
  }
  statement(e) {
